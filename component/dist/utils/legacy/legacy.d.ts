...
export declare class Legacy {
    ...
    static processCohere(cohere: CohereChat): boolean;
    ...
    static processPosition<T>(buttonPosition?: string): "inside-start" | "inside-end" | "outside-start" | "outside-end" | T;
    static processBrowserStorage(browserStorage: BrowserStorage): void;
}
